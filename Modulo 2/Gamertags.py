...
def Crear_Tag_Intercalado(nombre,apellido):
    ...
    print("⚔️--TAG INTERCALADO: ", inicial_nombre, inicial_apellido, resto_nombre, resto_apellido, sep="")
...
def Crear_Tag_ELite (nombre):
    ...
    print("⚔️--TAG ELITE: ", primeras_nombre, ultimas_nombre, sep="")
...
def Crear_Tag_Con_Numero(nombre,numero_fav):
   ...
   """
   numero_fav = 7
   print("⚔️--TAG CON NUMERO: ", nombre[:5], numero_fav,sep="")

#tag_numero = Crear_Tag_Con_Numero("Sonia",7)
...
#estadisticas = Mostrar_Estadisticas ("Sonia")
...
def Generar_todas_funciones(nombre,apellido,numero):
    ...
    print("⚔️--TAG BASICO:", tag)
    print("⚔️--TAG INVERTIDO:", Crear_Tag_Invertido(nombre))
...
#funciones = Generar_todas_funciones ("Sonia", "Alvarado", 7)
...
apellido = input("✍️  Introduce tu apellido: ")
numero = input("#️⃣  Introduce tu numero favorito: ")
